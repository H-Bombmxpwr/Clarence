...
def make_list():
  ...
  embedVar5.add_field(name = "Moderation Commands" , value =  "`help Moderation: ` for a list of moderation commands\most moderation commands require special permissions to use")
