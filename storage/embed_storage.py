...
#The embeds for the command list page of the bot
def make_list():
  ...
  embedVar4.add_field(name = "Page 4: Music Commands", value = "` music: ` to bring up a list of commands for the music player\n`lyrics: ` pull the lyrics to a requested song")
  ...
  embedVar5.add_field(name = "Page 5: Moderation Commands" , value =  "`help Moderation: ` for a list of moderation commands\most moderation commands require special permissions to use")
